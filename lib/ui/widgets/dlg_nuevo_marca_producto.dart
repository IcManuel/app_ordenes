...
class DialogoNuevaMarcaProducto extends StatelessWidget {
  const DialogoNuevaMarcaProducto({Key? key}) : super(key: key);
      ...
      child: Container(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: const Text('Crear marca de producto'),
            actions: [
              IconButton(
                onPressed: () {
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: () {
                        nuevoBloc.crearMarcaProducto(context, size);
                      },
